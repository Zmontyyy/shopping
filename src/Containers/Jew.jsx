...
import '../Style.css'
import { jewProducts } from '../Redux/Action/ProductsAction'
...
function Jew() {
  ...
  const fetchData = () => {
    fetch('https://fakestoreapi.com/products/category/jewelery')
      .then(res => res.json())
      .then(json => dispatch(jewProducts(json)))
  }
  useEffect(() => {
    fetchData()
  }, [])
            ...
            return (
              <div key={index} className="col-3">
                <div className=" box card  mt-2">
                  ...
                  <button className="btn btn-1 btn-primary mb-5 " onClick={() => send()}  >Buy Now</button>
                  {/* <Link to={'Cart'} >
                    </Link> */}
                </div>
